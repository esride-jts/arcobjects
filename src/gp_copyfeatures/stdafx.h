...
#import "\Program Files (x86)\ArcGIS\Desktop10.7\com\esriGeoprocessing.olb" raw_interfaces_only, raw_native_types, no_namespace, named_guids, rename("GetMessage", "EsriGeoprocessingGetMessage"), rename("GetObject", "EsriGeoprocessingGetObject")